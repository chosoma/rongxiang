...
public class IecSocketThread extends BaseService implements Runnable {
    ...
    public void setAgreement(IECAgreementConfig agreement) {
    ...
    public int receiveSeqNum = 0; //接收序号
    public int sendSeqNum = 0; // 发送序号，每发送一个后需+1
    @Override
    public void run() {
        try {
